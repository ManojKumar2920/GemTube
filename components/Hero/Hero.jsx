...
const Hero = () => {
  return (
    <div className=" p-10 w-full flex flex-col items-center justify-center">
      <div className=" w-[60%] text-center flex flex-col items-center justify-between gap-6">
        ...
        <SecondaryBtn href={"/"} children={'Join Waitlist'} />
      </div>
      <div className=" pt-12 w-[90%]">
        <Image src={HeroBanner} className=" shadow-xl rounded-2xl"></Image>
      </div>
    </div>
  );
};
